...
public class MapsActivity extends FragmentActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    //Private variables to keep track of various location-based information
    ...
    //Behavior when the user's location is clicked
    @Override
    public void onMyLocationClick(@NonNull Location location) {
    }

    //Behavior when the user's location button is clicked
    @Override
